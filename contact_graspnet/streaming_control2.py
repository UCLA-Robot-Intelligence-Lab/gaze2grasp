...
from homography2 import HomographyManager # Import HomographyManager
...
from segment.SAMInference import segment_rgb_image
            ...
            if aria.CameraId.Rgb in observer.images:
                ...
                if gaze is not None and np.mean(gaze) > 10 and np.median(gaze) > 10:
                    ...
                    if gaze_coordinates is not None:
                        ...
                        if frame_counter % sam_every_n_frames == 0:
                            seg_model = FastSAM('./contact_graspnet/segment/FastSAM-s.pt')
                            seg_mask, seg_centers = segment_rgb_image(
                                seg_model,
                                [gaze_coordinates],
                                display_image,
                                imgsz=1408,
                            ...
                            if seg_mask is not None:
                                ...
                                realsense_image, transformed_x, transformed_y = homography_manager.process_frame(
                                    seg_mask, gaze_coordinates, show_matches=True
                                )
                ...
                realsense_image, tx, ty = homography_manager.process_frame(
                    rgb_image, gaze_coordinates, show_matches=True
                )
