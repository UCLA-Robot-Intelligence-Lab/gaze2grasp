...
pcd = o3d.io.read_point_cloud("/home/u-ril/contact_graspnet/bowl.pcd") #replace with your pcd
...
np.save("./calib/extrinsic_317422074281_1.npy", pinhole_camera_parameters.extrinsic)

print("Extrinsic matrix saved to extrinsic_317422074281.npy")
